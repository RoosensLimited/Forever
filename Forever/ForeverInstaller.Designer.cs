namespace Forever
{
    partial class ForeverInstaller
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ForeverInstaller));
            pParent = new Panel();
            bNext = new Button();
            ...
            MaximizeBox = false;
            Name = "ForeverInstaller";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Forever";
            FormClosing += ForeverInstaller_FormClosing;
            ResumeLayout(false);
        }
